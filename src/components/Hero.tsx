...
const Hero = () => {
  return (
    <section className="w-full mb-10">
      ...
      {/* HERO SECTION */}
      <div className="relative h-[95vh] w-full overflow-hidden pt-10">
      ...
      <motion.div
        ...
        transition={{ duration: 0.8 }}
        className="bg-slate-950 text-gray-300 leading-relaxed text-lg p-6 text-center"
      >
        <h2 className="max-w-4xl mx-auto text-sm md:text-base">
