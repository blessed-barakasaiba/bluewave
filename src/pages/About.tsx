...
function AboutUsHero() {
  ...
  const service_info = [
    ...
    },
    {
      ...
      description:
        "Expert consulting, blast design, and on-site support to improve performance and ensure compliance",
    },
    {
      icon: <Sparkles />,
        ...
        <div className="mx-auto grid md:grid-cols-2 gap-10 items-start">
          ...
          >
            ...
            <p className="text-gray-700 text-lg md:text-xl leading-relaxed mb-4">
              BLUEWAVE MAWIMBI ENTERPRISES COMPANY LIMITED is a limited company
              with certificate of incorporation Number 186044487, P.O.BOX
              472,KAHAMA.
            </p>
            <p className="text-gray-700 text-lg md:text-xl leading-relaxed mb-4">
              BLUEWAVE MAWIMBI ENTERPRISES COMPANY LIMITED is a dynamic and
              reliable Tanzanian company specializing in the supply of mining
              tools and equipment, and providing professional services to mining
              and drilling companies.
            </p>
            <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
              We supply a wide range of commercial explosives, accessories and
              blasting consumables suitable for all mining and construction
              applications.
            </p>
            <br />
            <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
              Our experienced team delivers precise drilling. efficient blasting
              and controlled demolition solutions using modern equipment and
              industry best practices to maximize productivity and safety.
            </p>
            <br />
            <p className="text-gray-700 text-lg md:text-xl leading-relaxed">
              We are committed to safety, quality, reliability and timely
              delivery in every project we undertake.
            </p>
          </motion.div>
