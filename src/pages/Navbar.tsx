...
function Navbar() {
  ...
  return (
    <motion.section
      initial="hidden"
      animate="visible"
      className={`fixed top-0 left-0 w-full z-50 flex flex-row py-3 justify-between items-center px-4 md:px-6 lg:px-8 xl:px-16 2xl:px-70 transition-all duration-300 ${
        scrolled
    ...
    >
        ...
        {quick_links.map((link, index) => {
          ...
          return (
            ...
            >
              <Link
                to={link.path}
                className={`relative transition-all duration-300 p-2 inline-block font-medium ${
                  isActive
                    ? "text-blue-600"
      ...
      <div
        className="navbar-actions gap-4 items-center justify-center hidden lg:flex"
        onClick={() => goToWhatsApp()}
      >
        <motion.button
          whileTap="tap"
